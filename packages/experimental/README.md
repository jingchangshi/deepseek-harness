...
| [`browser-use-browser-harness-mcp`](browser-use-browser-harness-mcp/README.md) | Browser Harness tools over MCP against the user's running Chrome | `ctx.browserUse` |
