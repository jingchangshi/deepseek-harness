...
来源：[`packages/execution/execution-world/src/index.ts:16`](../packages/execution/execution-world/src/index.ts)
...
来源：[`packages/fs/fs-local/src/index.ts:46`](../packages/fs/fs-local/src/index.ts)
...
Depends on: [`ContentBlock`](subsystems/llm-streaming.zh.md) · [`JsonValue`](../packages/util/values/src/index.ts) · [`ToolExecution`](subsystems/tools.zh.md)
